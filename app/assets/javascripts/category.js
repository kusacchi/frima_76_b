  ...
  $(function () {
    ...
    function appendChidrenBox(insertHTML){
      ...
      childSelectHtml = `<select class="exhibitionPage__main__contents__detail__category__choose--select" id="child_category" name="exhibition[category_id]">
                            ...
                            ${insertHTML}
                        <select>`;
      $(".sell__main__content__form__box__group__selects").append(
        childSelectHtml
      );
    }
    ...
    // 子カテゴリー選択後のイベント
    $(".sell__main__content__form__box__group").on(
      "change",
      "#child_category",
      function () {
        var child_category_id = $("#child_category option:selected").data(
          "category"
        ); //選択された子カテゴリーのidを取得
